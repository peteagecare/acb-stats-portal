...
const DEFAULTS = {
  ...
  financeApprovalEmail: true,
  financeApprovalInApp: true,
  contentCalendarEmail: true,
  contentCalendarInApp: true,
  taskCompletedEmail: true,
  taskCompletedInApp: true,
  commentEmail: true,
  commentInApp: true,
  noteSharedEmail: true,
  noteSharedInApp: true,
  contentGoLiveEmail: true,
  contentGoLiveInApp: true,
  reviewEmail: true,
  reviewInApp: true,
  subscriptionEmail: true,
  subscriptionInApp: true,
  staleApprovalEmail: true,
  staleApprovalInApp: true,
  digestDailyEmail: true,
  digestDailyInApp: false,
  digestWeeklyEmail: true,
  digestWeeklyInApp: false,
};
